...
const HomeBannerOne = () => {
    return (
        <div className="carousel-item relative w-full mb-8 hidden lg:flex">
        <img src={homepagebanner1} className="w-full" />
        <div className="absolute flex items-center h-full left-0 top-0 justify-start bg-gradient-to-r from-[#004bf9] to-[rgba(21, 21, 21, 0)]">
